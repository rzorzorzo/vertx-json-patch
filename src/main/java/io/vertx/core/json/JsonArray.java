...
public class JsonArray implements Iterable<Object>, ClusterSerializable, Shareable
{
	...
	/**
	 * Create an instance from a String of JSON, this string must be a valid array
	 * otherwise an exception will be thrown.
	 * <p/>
	 * If you are unsure of the value, you should use instead
	 * {@link Json#decodeValue(String)} and check the result is a JSON array.
	 *
	 * @param json
	 *            the string of JSON
	 */
